...
object RetrofitClient {
    ...
    // Cliente para AUTH
    val apiAuth: ApiService by lazy { retrofitAuth.create(ApiService::class.java) }

    // Cliente para GRAFICAS
    val apiGraficas: ApiGraficas by lazy { retrofitApi.create(ApiGraficas::class.java) }
    ...
    val apiUser: ApiUser by lazy { retrofitApi.create(ApiUser::class.java) }
    val apiAi: ApiAiService by lazy { retrofitApi.create(ApiAiService::class.java) }
    val apiVoice: ApiVoice by lazy { retrofitApi.create(ApiVoice::class.java) }
}